...
class ResnetBuilder(object):
    ...
    @staticmethod
    def build_tiny(input, block_fn, repetitions):
...
if __name__ == '__main__':
    ...
    """
    x= tf.placeholder('float32',[None,450,100,10])
    resnet=ResnetBuilder.build_resnet_50([10,450,100],10)
    print(resnet.summary())
    input=resnet.get_layer('input_1').input
    output=resnet.get_layer('add_7').output
    resnet_f= Model(inputs=input, outputs=output)  #add_7
